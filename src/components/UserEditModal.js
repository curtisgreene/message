...
export default class UserEditModal extends React.Component {
 ...
 handleChange = (e, { name, value }) => {
  ...
  handleSubmit(event){ //optimistically updates the CurrentUserProfile on edit submit
    ...
    this.props.handleUpdateUser({id: this.state.id, username: this.state.username, profile: this.state.profile, url: this.state.uploadedFileCloudinaryUrl})
    this.props.onEdit({username: this.state.username, profile: this.state.profile, url: this.state.uploadedFileCloudinaryUrl})
    this.close()
  }
